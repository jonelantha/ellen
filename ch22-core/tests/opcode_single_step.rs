...
#[test]
fn _0b_test() {
    opcode_single_step_tests_from_file("0b");
}
...
#[test]
fn _11_test() {
    opcode_single_step_tests_from_file("11");
}
...
#[test]
fn _55_test() {
    opcode_single_step_tests_from_file("55");
}
...
#[test]
fn _61_test() {
    opcode_single_step_tests_from_file("61");
}
...
#[test]
fn _c1_test() {
    opcode_single_step_tests_from_file("c1");
}
...
#[test]
fn _d5_test() {
    opcode_single_step_tests_from_file("d5");
}

#[test]
fn _d6_test() {
    opcode_single_step_tests_from_file("d6");
}
